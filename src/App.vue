<template>
  <v-app>
    <v-navigation-drawer app v-model="drawer"><v-list-item>
      ...
      <v-list dense><v-list-item v-for="link in links" :key="link.title" :to="link.url">
    ...
    <v-app-bar app dark color="primary"> <v-app-bar-nav-icon @click="drawer = !drawer"></v-app-bar-nav-icon>
      <v-spacer></v-spacer>
